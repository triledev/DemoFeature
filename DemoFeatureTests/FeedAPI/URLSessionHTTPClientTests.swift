...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURLsucceedsOnHTTPURLResponseWithData() {
        let data = anyData()
        let response = anyHTTPURLResponse()

        let resultValues = resultValueFor(data: data, response: response, error: nil)
    ...
    func test_getFromURLsucceedsWithEmptyDataOnHTTPURLResponseWithNilData() {
        let response = anyHTTPURLResponse()

        let resultValues = resultValueFor(data: nil, response: response, error: nil)
